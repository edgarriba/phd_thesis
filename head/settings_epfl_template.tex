...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[10pt,fleqn, twoside, openright]{book}

\usepackage[T1]{fontenc}
\usepackage[utf8]{inputenc}
\usepackage[french,german,catalan,spanish,english]{babel}
\usepackage{authblk}
\usepackage{epigraph}
...
\titleformat{\chapter}[display]  % type (section,chapter,etc...) to vary,  shape (eg display-type)
	{\normalfont\bfseries\LARGE} % format of the chapter
    ...
    \node[yshift=-4cm] at (current page.north west)
      {\begin{tikzpicture}[remember picture, overlay]
        ...
        \node[anchor=north east,yshift=-3.2cm,xshift=34mm,minimum height=10mm,inner sep=0mm] at (current page.north west)
        {\parbox[top][40mm][t]{15mm}{\raggedleft $\phantom{\textrm{l}}$\color{white}\chapterlabel}};  %the black l is just to get better base-line alingement
        \node[anchor=north west,yshift=-3.2cm,xshift=37mm,text width=\textwidth,minimum height=10mm,inner sep=0mm] at (current page.north west)
              {\parbox[top][10mm][t]{\textwidth}{\color{black}#1}};
       \end{tikzpicture}
      };
   \end{tikzpicture}
   \gdef\chapterlabel{}
...
\titlespacing*{\section}{0pt}{13.2pt}{10pt}  % 13.2pt is line spacing for a text with 11pt font size
\titlespacing*{\subsection}{0pt}{13.2pt}{6pt}
\titlespacing*{\subsubsection}{0pt}{13.2pt}{4pt}
    ...
    \node[anchor=north west,xshift=-65mm,yshift=-6.9cm-\value{myparts}*20mm] at (current page.north east) % for unknown reasons: 3mm missing -> 65 instead of 62
      {\begin{tikzpicture}[remember picture, overlay]
        ...
        \node[anchor=north east,yshift=-6.1cm-\value{myparts}*20mm,xshift=-63.5mm,text width=\textwidth,minimum height=30mm,inner sep=0mm] at (current page.north east)
              {\parbox[top][30mm][t]{\textwidth}{\raggedleft \color{black}#1} \thispagestyle{empty}};
       \end{tikzpicture}
      };
   \end{tikzpicture}
   \gdef\partlabel{}
   %{\vspace{80mm}\includegraphics[width=1\textwidth]{images/part2.eps}}
   {\parbox[top][\partspacex mm][t]{\textwidth}{\includegraphics[width=1\textwidth]{\partimagex} \begin{center}\vspace{-8mm}{\center \small \partcapx}\end{center}}}
  } % code before the title body
...
%{\normalfont\huge\filcenter\bfseries\thispagestyle{empty}}
%{\partname\ \thepart}
%{20pt}
%{\Huge}
