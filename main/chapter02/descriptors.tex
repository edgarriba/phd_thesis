...
\begin{figure}
\centering    
\subfigure{\includegraphics[trim={2.1cm 0 2.1cm 0},width=0.24\textwidth]{main/chapter02/images/dog_ranking}}
\subfigure{\includegraphics[trim={2.1cm 0 2.1cm 0},width=0.24\textwidth]{main/chapter02/images/dog_ratio}}
\subfigure{\includegraphics[trim={2.1cm 0 2.1cm 0},width=0.24\textwidth]{main/chapter02/images/haraff_ranking}}
\subfigure{\includegraphics[trim={2.1cm 0 2.1cm 0},width=0.24\textwidth]{main/chapter02/images/haraff_ratio}}
...
\begin{figure}
\centering    
\subfigure{{\includegraphics[trim={0.5cm 1.2cm 0.5cm 1.8cm},width=0.48\textwidth]{main/chapter02/images/oxford_dog}}}
\subfigure{{\includegraphics[trim={0.5cm 1.2cm 0.5cm 1.8cm},width=0.48\textwidth]{main/chapter02/images/oxford_haraff}}}
