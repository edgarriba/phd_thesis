...
%In the future, we expect researchers and companies increase the number of contributions to the project to grow on other areas such as Structure from Motion or volumetric image transformations. At the time of this submission, \lib{} has 2450 GitHub stars and 250 forks and up to 50 contributors and it's been used by more than 50 projects.